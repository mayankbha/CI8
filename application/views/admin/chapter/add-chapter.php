...
<section class="content">
	<form enctype="multipart/form-data" class="form" id="add-chapter" method="post" action="<?php echo current_url(); ?>">
	          ...
	          <div class="row">
	            ...
	            <div class="col-md-6 col-md-offset-3">
	              <div class="form-group">
	                ...
	                <input required class="form-control" type="text" name="chapter_title" id="lesson_title" value="<?php echo $this->input->post('lesson_title'); ?>">
	              </div>
	              <!-- /.form-group -->
	              <div class="form-group">
	                <label>Sort Order</label>
	               <input class="form-control" type="number" name="chapter_sort_order" id="lesson_sort_order" value="<?php echo $this->input->post('lesson_sort_order') ? $this->input->post('lesson_sort_order') : 1; ?>">
	              </div>
	              <!-- /.form-group -->
