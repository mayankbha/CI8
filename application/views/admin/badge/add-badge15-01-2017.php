		...
		<div class="box box-info">
					...
					<tr class="lesson-tool-single" data-current="1">
						<td>
							<div class="form-group">
								...
								<select required class="form-control lesson-tool" name="Criteria" id="Criteria">
          ...
          <tr class="lesson-tool-single" data-current="1">
            ...
            <!--	<td align="right" valign="bottom">
					...
					<tr class="lesson-tool-single" id="tool" style="display:none;" data-current="1">
          	<td>
							<div class="form-group" >
								<label>Tools</label>
								<select required class="form-control lesson-tool-id" name="lesson_tools[1][object_id]" id="">
					...
					<tr class="lesson-tool-single"  id="percentage" style="display:none;" data-current="1">
          	<td>
							<div class="form-group">
