...
$('#button-search').on('click', function(e) {
	var url = '<?php echo base_url("admin/common/filemanager"); ?>?token=<?php echo $token; ?>&directory=<?php echo $directory; ?>';
...
$('#button-folder').on('shown.bs.popover', function() {
	$('#button-create').on('click', function() {
		$.ajax({
			url: '<?php echo base_url("admin/common/filemanager"); ?>/folder?token=<?php echo $token; ?>&directory=<?php echo $directory; ?>',
			type: 'post',
			dataType: 'json',
...
$('#modal-image #button-delete').on('click', function(e) {
	if (confirm('<?php echo $text_confirm; ?>')) {
		$.ajax({
			url: '<?php echo base_url("admin/common/filemanager"); ?>/delete?token=<?php echo $token; ?>',
			type: 'post',
			dataType: 'json',
