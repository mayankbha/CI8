		...
		<div class="login-box-body">
			...
			<form action="<?php echo current_url(); ?>" method="post">
				<div class="form-group has-feedback">
					<input autofocus="true" type="email" name="email" id="email" value="<?php echo $this->input->post('email') ?>" class="form-control" placeholder="Email">
					<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
				</div>
				<div class="row">
					<div class="col-xs-4">
						<button name="reset" type="submit" class="btn btn-primary btn-block btn-flat">Reset</button>
					</div>
					<!-- /.col -->
				</div>
			</form>
