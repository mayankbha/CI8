      ...
      <div class="inner-sec">
        <div class="row">
          ...
          <div class="col-lg-8 right-sd pad-lft-01">
			<form id="quiz-question-form" class="form" method="post" action="<?php echo base_url('student/lessonquiz/process_answer'); ?>" >
                    ...
                    <input type="hidden" name="lessonquiz" value="<?php echo $lessonquiz; ?>" />
                    <input type="hidden" name="lesson_attempt_id" value="<?php echo $lesson_attempt_id; ?>" />
